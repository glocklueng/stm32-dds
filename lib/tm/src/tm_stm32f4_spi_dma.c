...
/* Private variables */
#ifdef SPI1
static TM_SPI_DMA_INT_t SPI1_DMA_INT = { SPI1_DMA_TX_CHANNEL,
                                         SPI1_DMA_TX_STREAM,
                                         SPI1_DMA_RX_CHANNEL,
                                         SPI1_DMA_RX_STREAM };
#endif
#ifdef SPI2
static TM_SPI_DMA_INT_t SPI2_DMA_INT = { SPI2_DMA_TX_CHANNEL,
                                         SPI2_DMA_TX_STREAM,
                                         SPI2_DMA_RX_CHANNEL,
                                         SPI2_DMA_RX_STREAM };
#endif
#ifdef SPI3
static TM_SPI_DMA_INT_t SPI3_DMA_INT = { SPI3_DMA_TX_CHANNEL,
                                         SPI3_DMA_TX_STREAM,
                                         SPI3_DMA_RX_CHANNEL,
                                         SPI3_DMA_RX_STREAM };
#endif
#ifdef SPI4
static TM_SPI_DMA_INT_t SPI4_DMA_INT = { SPI4_DMA_TX_CHANNEL,
                                         SPI4_DMA_TX_STREAM,
                                         SPI4_DMA_RX_CHANNEL,
                                         SPI4_DMA_RX_STREAM };
#endif
#ifdef SPI5
static TM_SPI_DMA_INT_t SPI5_DMA_INT = { SPI5_DMA_TX_CHANNEL,
                                         SPI5_DMA_TX_STREAM,
                                         SPI5_DMA_RX_CHANNEL,
                                         SPI5_DMA_RX_STREAM };
#endif
#ifdef SPI6
static TM_SPI_DMA_INT_t SPI6_DMA_INT = { SPI6_DMA_TX_CHANNEL,
                                         SPI6_DMA_TX_STREAM,
                                         SPI6_DMA_RX_CHANNEL,
                                         SPI6_DMA_RX_STREAM };
#endif
...
void
TM_SPI_DMA_InitWithStreamAndChannel(SPI_TypeDef* SPIx,
                                    DMA_Stream_TypeDef* TX_Stream,
                                    uint32_t TX_Channel,
                                    DMA_Stream_TypeDef* RX_Stream,
                                    uint32_t RX_Channel)
...
uint8_t
TM_SPI_DMA_Transmit(SPI_TypeDef* SPIx, uint8_t* TX_Buffer, uint8_t* RX_Buffer,
                    uint16_t count)
{
  /* Get USART settings */
  TM_SPI_DMA_INT_t* Settings = TM_SPI_DMA_INT_GetSettings(SPIx);
  ...
  if (Settings->RX_Stream->NDTR || Settings->TX_Stream->NDTR ||
...
TM_SPI_DMA_SendByte(SPI_TypeDef* SPIx, uint8_t value, uint16_t count)
{
  ...
  /* Set DMA peripheral address, number of bytes and disable memory increase
   * pointer */
  DMA_InitStruct.DMA_PeripheralBaseAddr = (uint32_t)&SPIx->DR;
  DMA_InitStruct.DMA_BufferSize = count;
  DMA_InitStruct.DMA_MemoryInc = DMA_MemoryInc_Disable;
...
TM_SPI_DMA_Working(SPI_TypeDef* SPIx)
{
  ...
  return (Settings->RX_Stream->NDTR || /*!< RX is working */
