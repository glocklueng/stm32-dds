...
/**
 * @defgroup TM_GPIO
 * @brief    TM GPIO Library for STM32F4xx -
...
0
 Version 1.1
  - March 09, 2015
  - Added function to deinit pin. Pin is set to analog input which allows lowest
current consumption
...
#define GPIO_Pin_All ((uint16_t)0xFFFF)
   ...
   * @param  GPIO_Mode: Select GPIO mode. This parameter can be a value of @ref
   * TM_GPIO_Mode_t enumeration
   * @param  GPIO_OType: Select GPIO Output type. This parameter can be a value
   * of @ref TM_GPIO_OType_t enumeration
   * @param  GPIO_PuPd: Select GPIO pull resistor. This parameter can be a value
   * of @ref TM_GPIO_PuPd_t enumeration
   * @param  GPIO_Speed: Select GPIO speed. This parameter can be a value of
   * @ref TM_GPIO_Speed_t enumeration
   * @retval None
   */
   ...
   * @retval None
   */
  void TM_GPIO_InitAlternate(
    GPIO_TypeDef * GPIOx, uint16_t GPIO_Pin, TM_GPIO_OType_t GPIO_OType,
   ...
   * @param  GPIO_Pin: Select GPIO pin(s). You can select more pins with | (OR)
   * operator to set them as input
   * @retval None
   */
   ...
   * @param  GPIO_Pin: Select GPIO pin(s). You can select more pins with | (OR)
   * operator to set them as output
   * @retval None
   */
   ...
   * @param  GPIO_Pin: Select GPIO pin(s). You can select more pins with | (OR)
   * operator to set them as analog
   * @retval None
   */
   ...
   * @param  GPIO_Pin: Select GPIO pin(s). You can select more pins with | (OR)
   * operator to set them as alternate
   * @retval None
   */
   ...
   * @param  GPIO_Pin: Select GPIO pin(s). You can select more pins with | (OR)
   * operator to set them as output
   * @param  GPIO_PuPd: Pull resistor option. This parameter can be a value of
   * @ref TM_GPIO_PuPd_t enumeration
   * @retval None
   */
 ...
 * @param  GPIO_Pin: Select GPIO pin(s). You can select more pins with | (OR)
 * operator to toggle them all at a time
 * @retval None
 */
