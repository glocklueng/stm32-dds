...
static void update_state(ad9910_target, ad9910_command_type);
...
prepare_command(ad9910_target tgt, ad9910_command_type cmd, const void* data)
{
  ...
  switch (cmd) {
    ...
    case ad9910_command_fixed:
      ...
      ret = sizeof(ad9910_fixed_command);
    case ad9910_command_parallel:
      prepare_parallel_command(tgt, data);
      ret = sizeof(ad9910_parallel_command);
    case ad9910_command_ram:
      prepare_ram_command(tgt, data);
      ret = sizeof(ad9910_ram_command);
    case ad9910_command_ramp:
      prepare_ramp_command(tgt, data);
      ret = sizeof(ad9910_ramp_command);
  }

  update_state(tgt, cmd);
...
static void
update_state(ad9910_target tgt, ad9910_command_type cmd)
{
  if (cmd == ad9910_command_none) {
    return;
  }

  switch (tgt) {
    case ad9910_frequency:
      command_state.frequency = cmd;
    case ad9910_amplitude:
      command_state.amplitude = cmd;
    case ad9910_phase:
      command_state.phase = cmd;
  }
}
